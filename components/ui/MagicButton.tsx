...
const MagicButton = ({ Child, Child2, href }: MagicButtonProps) => {
  const content = (
    <>
  ...
  // If href is provided, render <a>, otherwise render <button>
  return (
    <div className="w-full flex justify-center mt-8 between0_467:mt-4">
      {href ? (
        <a
          ...
          className="relative inline-flex h-12 w-52 overflow-hidden rounded-full p-[1px]"
        >
          {content}
        </a>
      ) : (
